...
class Events extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            titles: ["cyberquest", "aerodynamix", "electromania", "genesis", "mechrocosm", "nirmaan", "cyberquest", "aerodynamix", "electromania",]
        }
    }
    ...
    handleClick = (index, $elem) => {
        ...
        const { finalLeft, finalTop, scaleFactor } = this.getAnimationValues($elem.offsetWidth);
        ...
        $imgContainer.style.transform = `translate(0%,-25%)  scale(${1 / scaleFactor})`;
